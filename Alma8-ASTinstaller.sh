...
svn checkout -r 3769 svn://svn.eflo.net/agc_2-X/trunk
...
###certbot renew
51 23 1 * * systemctl stop firewalld
52 23 1 * * certbot renew
53 23 1 * * systemctl start firewalld
54 23 1 * * systemctl restart httpd
